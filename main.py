...
from dataset_builder.retrieval import run_dataset_from_config
from preprocessing.pipeline import run_preprocessing
from training.train import run_training
from utils.config import load_config
from utils.logger import setup_logger
from db.schema_extract import run_schema_from_config
...
def main() -> None:
    ...
    for step in steps:
        if step == "schema":
            run_schema_from_config(config)
        elif step == "dataset":
            run_dataset_from_config(config)
